<nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
  ...
  <ul class="nav nav-pills flex-column">
    <li class="nav-item">
      <a id="projects" class="nav-link active" href="{{URL::route('projects')}}" onclick="onClickActiveNav('projects')">
        <i class="icon-Projects_Icon"></i> Projeler
      </a>
    </li>
    <li class="nav-item">
      <a id="postures" class="nav-link"
